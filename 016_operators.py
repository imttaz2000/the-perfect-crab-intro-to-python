...
print(f"5 > 3 = {5 > 3} (should be True)")
print(f"2 < 1 = {2 < 1} (should be False)")
print(f"4 == 4 = {4 == 4} (should be True)")
print(f"4 != 5 = {4 != 5} (should be True)")
print(f"(2 + 3) > (1 * 4) = {(2 + 3) > (1 * 4)} (should be True)")
